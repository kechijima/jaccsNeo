...
<template>
  <Teleport to="body">
    ...
    >
      <div class="bg-white w-full max-w-xs rounded-2xl p-5 space-y-4 shadow-xl text-center">
        <div class="flex h-12 w-12 mx-auto items-center justify-center rounded-full bg-primary-100 text-primary-700 font-semibold">
